...
_That chain of transactions is an eletronic coin._ Why?
...
Here is how a transaction works:
    ...
    a. Owner #1 is the current owner of the electronic coin.
    b. Owner #1 decides to transact and transfer the electronic coin to owner #2. 
    c. Owner #1 gets a public identifier of owner #2, a reference to the previous transaction (that basically describes how he became the current owner), and its own digital signature.
    d. A new transaction is created with all of that information.
    e. Owner #2 can verify that the signature is correct and is now the owner of the electronic coin.
